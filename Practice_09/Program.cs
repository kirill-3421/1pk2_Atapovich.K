...
namespace Practice_09
{
    internal class Program
    {
       ...
       Для вывода выручки от аренды всех автомобилей за все даты в системе
         */
                ...
                if (int.TryParse(Console.ReadLine(), out int choice))
                {
                    switch (choice)
                    {
                        ...
                        case 4:
                            ...
                            break;
                        case 5:
                            double totalRevenue = Carshering.GetTotalRevenue(); // Предполагается, что есть метод GetTotalRevenue
